...
def parse_args():
    ...
    parser.add_argument('--data-dir', type=str, default='pytorch-animeGAN-master\Data\dataset')
    parser.add_argument('--epochs', type=int, default=100)
    parser.add_argument('--init-epochs', type=int, default=0)
    parser.add_argument('--batch-size', type=int, default=6)
    parser.add_argument('--checkpoint-dir', type=str, default='pytorch-animeGAN-master\weight')#'/content/checkpoints')
...
def main(args):
    ...
    for e in range(start_e, args.epochs):
        ...
        for img, anime, anime_gray, anime_smt_gray in bar:
            ...
            # 修改了判别器的损失计算函数，增加了两个分割结果经过判别器判别的损失
